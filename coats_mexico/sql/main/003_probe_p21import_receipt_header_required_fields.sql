...
DECLARE @ContainerReceiptsHdrStatus int = 971;
...
(
    ...
    NULL,
    'row_status_flag',
    'Manual guidance: create header first and set row_status_flag = 971 (Unapproved) before line inserts. This table does not expose a container_name column in INFORMATION_SCHEMA.'
);
